...
CREATE TABLE vendor_certificates (
    ...
    FOREIGN KEY (verified_by) REFERENCES users(id) ON DELETE RESTRICT,
    INDEX idx_vendor_profile (vendor_profile_id),
    INDEX idx_status (status),
...
CREATE TABLE chatbot_conversations (
    ...
    FOREIGN KEY (customer_id) REFERENCES users(id) ON DELETE CASCADE,
    INDEX idx_user_session (customer_id, session_id),
    INDEX idx_active (is_active),
...
CREATE TABLE forum_posts (
    ...
    FOREIGN KEY (customer_id) REFERENCES users(id) ON DELETE CASCADE,
    INDEX idx_forum_category (forum_category_id),
    INDEX idx_user (customer_id),
    INDEX idx_slug (slug),
...
CREATE TABLE requests (
    ...
    reference_type VARCHAR(50) NULL COMMENT 'Loại thực thể tham chiếu (order, cashout, vendor_profile, v.v.)',
    ...
    reply_notes TEXT NULL COMMENT 'Ghi chú nội bộ từ admin/nhân viên',
...
-- =========================
-- FINANCE (Wallet/Cashout/Transaction)
-- =========================
